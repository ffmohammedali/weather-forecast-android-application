...
/**
 * The configuration screen for the {@link WeatherWidget WartherWidget} AppWidget.
 */
public class WeatherWidgetConfigureActivity extends Activity {

    private static final String PREFS_NAME = "com.example.weatherforecastapp.weatherwidget.WartherWidget";
...
// out of the widget placement if the user presses the back button.
        ...
        setContentView(R.layout.warther_widget_configure);
